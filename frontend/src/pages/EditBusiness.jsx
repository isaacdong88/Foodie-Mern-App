...
import { logout, reset } from "../features/auth/authBusinessSlice";
    ...
    <div>
      <form className="formfield" onSubmit={handleSubmit}>
        <input
          ...
          value={formDish.searchterm}
          placeholder="Search Items for Menu"
        />
        <input type="submit" value="Search" />
      </form>
      <form action=""></form>
      <div className="meal-Result">{dish ? dish : "Search for Menu items"}</div>
